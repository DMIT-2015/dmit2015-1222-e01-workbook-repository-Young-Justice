...
class CanadianPersonalIncomeTaxManagerTest {
    ...
    void readAllLinesFromCsvFile() {
        ...
        // There should be 568 elements in the list
        assertEquals(567, allLines.size());
        // Check the first and last element of the file
        final String firstElement = "CAN,Canada,2023,1,0,53359,0.1500,0.00";
        final int firstElementIndex = 0;
        final String lastElement = "NU,Nunavut,2015,4,138586,,0.1150,9489.22";
